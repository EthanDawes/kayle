...
export type AssemblyPrintList = Node &
  PrintList & {
...
export type DiningCourt = Location &
  Node & {
...
/** Represents a print list for line card printing. */
export type LineCardPrintList = Node &
  PrintList & {
...
export type RetailLocation = Location &
  Node & {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    allFoods(
      variables: AllFoodsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<AllFoodsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AllFoodsQuery>({
            document: AllFoodsDocument,
            variables,
    ...
    diningCourts(
      variables: DiningCourtsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<DiningCourtsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DiningCourtsQuery>({
            document: DiningCourtsDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
